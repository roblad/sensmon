        ...
        <table class="table" >
            ...
            <tr ng-repeat="(k,v)  in array">
            	...
            	<td style="text-align:center" ng-repeat="(i,j) in v.sensors|orderBy: i.sensors |nodate  " ng-mouseover="hoverIn()" ng-mouseleave="hoverOut()" 
                    ng-class="{danger: i=='ftank' && j.raw==1 || i=='batvol' && j.raw<3.5 || i=='temp' && j.raw<-10, warning: i=='temp' && j.raw<0 || i=='deszcz' && j.raw==1 || i=='ewob' && j.raw==1 || i=='prad' && j.raw>2 || i=='temp' && j.raw<20|| i=='tgroundhumi' && j.raw>90, success: i=='temp' && j.raw>23}">
